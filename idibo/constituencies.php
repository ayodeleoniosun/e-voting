...
<head>
    <meta charset="UTF-8" />
    <title><?php echo $admin_title;?> | Constituencies </title>
            ...
            <div class="inner" style="min-height: 700px;">
                <div class="row">
                    <div class="col-md-12 col-sm-12">
                        <h1 align="center"><i class="icon-star"></i> Constituencies </h1>
                    </div>
                </div>
                  <hr />
				...
				<div class="col-md-8 col-sm-8">
					...
					$(document).ready(function()
					{
						...
						$.ajax(
						{
							...
							data: dataString,
							cache:false,
							url:"display?DisplayAllConstituencies",
							
							success:function(msg)
							{
								$("#display_constituencies").html(msg);
							}
						});
					});
				</script>
					
					<div id="fetch_constituencies"></div>
					<div id="display_constituencies"></div>
					<div id='edit_constituencies'></div>
				</div>
			
				<div class="well col-md-4 col-sm-4">
					<div class="white">
						<div id="collapse2" class="body collapse in">
						   <h4 align="center"><i class="icon-plus"></i> Add Constituencies </h5>
						   <form id="add_constituency_form" method="post" class="form-horizontal">
								...
								<div class="form-group">
                                    ...
                                    <label>Constituency</label>
                                    	<input type="text" id="dept" name="constituency" class="form-control" placeholder="A1"/>
									</div>
								</div>
								
								<button type="submit" id="add_dept" class="btn btn-success "><i class="icon-plus"></i> Add </button>
