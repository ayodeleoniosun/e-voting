...
<head>
    <meta charset="UTF-8" />
    <title><?php echo $admin_title;?> | Accreditation </title>
    ...
    <!-- HEADER SECTION -->
       ...
       <div id="left">
        ...
        <div id="content">
            ...
            <div class="row">
				<h2 align="center"><i class="icon-user"></i> All Accredited Voters<hr/> </h2>
                
				<div class="col-lg-12">
					
					<ul class="nav nav-tabs">
						<li class="active"><a href="#add-voters-single" data-toggle="tab">Accredit voters </a>
						</li>
						<li><a href="#view-voters" data-toggle="tab">View accredited voters <span id='count_vote_voters' class="label label-default"><?php echo count_accredited();?></span></a></li>
                    </ul>

					<div class="tab-content">
						<div class="tab-pane fade in active" id="add-voters-single">
							<h4><i class="icon-plus"></i> Accredit voters <hr/></h4>
								<form id="accredit_form" method="post" class="form-horizontal">
									...
									<div class="col-md-8 col-sm-8">
										...
										<label>PIN</label>
										<input type="text" id="pin" name="pin" class="form-control" placeholder="Enter the pin given to the voter"  maxlength="6" onkeypress="return isNumberKey(event)"/>
										
										<br/>
										
									<div style="clear:both"></div>
									
									<button type="submit" class="btn btn-md btn-success pull-left"><i class="icon-plus"></i> Accredit</button>
									</div>
									<div style="clear:both"></div>
									<div id="accredit_status"></div>
			                    </form> 
						</div>
