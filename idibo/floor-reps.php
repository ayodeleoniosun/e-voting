...
<head>
    <meta charset="UTF-8" />
    <title><?php echo $admin_title;?> | Floor Reps </title>
       ...
       <div id="left">
            <ul id="menu" class="collapse">
                ...
                <li class="panel active">
                    <a href="floor-reps">
                        <i class="icon-location-arrow"></i> Floor reps &nbsp; <span id='count_reps' class="label label-default"><?php echo count_floor_reps();?></span>&nbsp; 
                    </a>                   
                </li>
        ...
        <div id="content">
            ...
            <div class="row">
				<h2 align="center"><i class="icon-group"></i> All Floor Reps<hr/> </h2>
                
				<div class="col-md-12 col-sm-12">
					
					<ul class="nav nav-tabs">
						<li class="active"><a href="#add-floor-reps" data-toggle="tab">Add Floor Reps</a>
						</li>
						<li><a href="#view-reps" data-toggle="tab">View Floor Reps <span id='count_vote_reps' class="label label-default"><?php echo count_floor_reps();?></span></a>
						</li>
					</ul>

					<div class="tab-content">
						
						<div class="tab-pane fade in active" id="add-floor-reps">
							...
							{
							?>
								<h4><i class="icon-plus"></i> Add Floor Reps <hr/></h4>
								<div class="form-group">
										<p><i><b> Ensure that a photo of 640px by 640px is uploaded, else the photo will be distorted. </b></i></p><br/>
                                        
                                   	<form id="add_rep_form" method="post" class="form-horizontal" enctype="multipart/form-data">
										
										<div class="col-md-12 col-sm-12">
							
											<div class="col-md-4 col-sm-4">
												<label>Upload floor rep's picture</label>
													<div class="fileupload fileupload-new" data-provides="fileupload">
														<div class="fileupload-preview thumbnail" style="width: 200px; height: 150px;"></div>
														<div>
															<br/><span class="btn btn-file btn-info"><span class="fileupload-new"><i class="icon-camera"></i>  Select floor rep's photo</span><span class="fileupload-exists"><i class="icon-mail-forward "></i> Change</span>
															<input type="file" id="rep_photo" name="rep_photo" accept=".jpg,.jpeg,.png,.JPG,.PNG,.JPEG"/>
																</span>
											...
											<div class="form-group">
												...
												<input type="text" id="fullname" name="fullname" class="form-control" placeholder="Samson King"/>
											</div>
											
											<div class="form-group">
												<label>Nickname  <i>(Optional)</i></label>
												<input type="text" id="nickname" name="nickname" class="form-control" placeholder="Samzy"/>
											</div>
						...
						<div class="tab-pane fade" id="view-reps">
