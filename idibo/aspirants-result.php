...
<head>
    <meta charset="UTF-8" />
    <title>Aspirants Election Result </title>
					...
					<script type="text/javascript">
						...
						$(document).ready(function()
						{
							...
							$.ajaxSetup(
							{
								beforeSend: function()
								{
									$("#fetch").html("Retrieving all aspirants' result &nbsp; <img src='../images/loading_bar.gif'/><br/>");
								},
								complete: function()
								{
									$("#fetch").html("");
							...
							$.ajax(
							{
								...
								data: dataString,
								cache:false,
								url:"display?DisplayAllAspirantsResult",
