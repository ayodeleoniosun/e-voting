...
<head>
    <meta charset="UTF-8" />
    <title><?php echo $admin_title;?> | Voters </title>
            ...
            <div class="row">
				...
				<div class="col-lg-12">
					...
					<ul class="nav nav-tabs">
						<li class="active"><a href="#add-voters-single" data-toggle="tab">Add voters (single)</a>
						</li>
						<li><a href="#add-voters-bulk" data-toggle="tab">Add voters (bulk)</a>
						</li>
						<li><a href="#view-voters" data-toggle="tab">View voters <span id='count_vote_voters' class="label label-default"><?php echo count_voters();?></span></a></li>
                        <li><a href="#view-voted" data-toggle="tab">View voted <span id='count_vote_voted' class="label label-default"><?php echo count_voted();?></span></a>
                        </li>
		            </ul>

					<div class="tab-content">
						<div class="tab-pane fade in active" id="add-voters-single">
							<h4><i class="icon-plus"></i> Add voters (single)<hr/></h4>
								<form id="add_voters_single_form" method="post" class="form-horizontal">
								
									<div class="col-md-8 col-sm-8">
										<label>Matric Number</label>
										<input type="text" id="matric" name="matric" class="form-control" placeholder="Enter the matric no of the voter"  maxlength="6" onkeypress="return isNumberKey(event)"/>
										
										<br/>

										<div class="">
											<label>Select constituency</label>
											<?php echo fetch_all_constituencies();?>
										</div>
									...
									<button type="submit" class="btn btn-md btn-success pull-left"><i class="icon-plus"></i> Add</button>
									</div>
								</form> 
						</div>
					
						<div class="tab-pane fade" id="add-voters-bulk">
							
							<h4><i class="icon-plus"></i> Add voters<hr/></h4>
							<form id="add_voters_bulk_form" method="post" enctype="multipart/form-data" class="form-horizontal">
								<div class="form-group">
			                        <div class="col-lg-8">
			                            <p> Select excel file that contains the voters' details and click on the upload button below. <br/>
			                            	Ensure the correct format for structuring the voters details is adhered to, otherwise, data will be wrongly uploaded. </p>
			                            <p> Sample of the format </p>
			                            <img src="../files/csv_format.png"/> <p></p>
			                            <div class="fileupload fileupload-new" data-provides="fileupload">
											<div class="input-group">
			                                  	<span class="btn btn-file btn-info">
			                                        <span class="fileupload-new">Select voters list file</span>
			                        	...
			                        	<button type="submit" class="btn btn-success pull-left"><i class="icon-upload"></i> Upload</button>
						...
						<div class="tab-pane fade" id="view-voters">
						...
						<div class="tab-pane fade" id="view-voted">
							...
							<script type="text/javascript">
								...
								$(document).ready(function()
								{
									...
									$.ajaxSetup(
									{
										beforeSend: function()
										{
											$("#fetch").html("Retrieving all voted &nbsp; <img src='../images/loading_bar.gif'/><br/>");
										},
										complete: function()
										{
											$("#fetch").html("");
							...
							<div id='fetch'>  </div>	
							<div id='display_voted'>  </div>	
							<div id='display_search_voted'>  </div>    
                            <div id='display_modify_voted'>  </div>
							<div id='display_search_modify_voted'>  </div>
                            <div class="clearfix"> </div>
						</div>
