...
<head>
    <meta charset="UTF-8" />
    <title><?php echo $admin_title;?> | Election result </title>
    ...
    <!-- HEADER SECTION -->
       ...
       <div id="left">
            <ul id="menu" class="collapse">
                ...
                <li class="panel">
                    <a href="aspirants">
                        <i class="icon-location-arrow"></i> Aspirants &nbsp; <span id='count_aspirants' class="label label-default"><?php echo count_aspirants();?></span>&nbsp; 
                    </a>                   
                </li>
        ...
        <div id="content">
            ...
            <div class="row">
				<h2 align="center"><i class="icon-signal"></i> Election result </h2>
			...
			<?php
                ...
                if($count_voted > 0)
                {
	                ...
	                <hr/> 
	                <div align="center">
		                	<h3> Election status </h3> <div class="progress progress-striped active">
					...
					<h4> <i class="icon-thumbs-up"></i> Only <b><?php echo $count_voted;?> (<?php echo $percent;?>%)</b> out of <b><?php echo $count_voters;?></b> voters voted.  &nbsp; <a href='voters' class='btn btn-sm btn-success'>Click to view all that have voted </a> </h4>
				<?php
				}
	            ...
	            {	
					...
					<div id="print_result_div<?php echo $i;?>">
						...
						for($k=1;$k<=$count;$k++)
						{
							...
							$count_against_votes = count_aspirant_against_votes($aspirant_id);	
							$votes_array[] = $count_votes;
							$votes_against_array[] = $count_against_votes;
							...
							?>         
								...
								<div class="col-md-8 col-sm-8">
									<h3> Fullname &raquo; <b><span class='text-info'><?php echo $aspirant_fullname;?></span> </b> </h3><hr/>

									<h4> Nickname &raquo; <?php echo $aspirant_nickname;?> </h4><hr/>

									<h4> Total votes for : <span class="vote_count"> <?php echo $count_votes;?> </span></h3><hr/>

									<h4> Total votes against : <span class="vote_count"> <?php echo $count_against_votes;?> </span> </h3> 
					...
					<div id="print_result_div<?php echo $i;?>">
						...
						<div class="vote_head" align='center'>ELECTIN RESULT FOR THE POST OF THE <?php echo strtoupper($post_name);?></div>
						...
						$combine_array = combine_array($aspirant_array,$votes_array);
						$combine_against_array = combine_array($aspirant_array,$votes_against_array);
						
						print_r($combine_array);
						print_r($combine_against_array);
						$max_vote = max($combine_array);
