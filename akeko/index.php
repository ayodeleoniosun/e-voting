...
<head>
  ...
  <body oncontextmenu="return false;" style="background-image:url('../images/bg.png')">
  ...
  <br/>
			...
			?>
				<script>
					$(document).ready(function()
					{
						...
						$("#support_ajax_status").html("<i class='icon-check'></i> Thanks for voting. Bye!").delay(4000).fadeOut("slow");
					});
				</script>
			<?php
	...
	?>
        ...
        <br/><form id="student_login_form" method="post" class="form-signin" autocomplete="off">
            ...
            <hr/>
            <div align="center">
              <i> Login below with your matric number and the 6 digits PIN given to you </i>
            </div>
            <br/>
            <label>Matric Number:</label>
              <input type="text" id="matric" name="matric" class="form-control" maxlength="6" onkeypress="return isNumberKey(event)"/>
              <br/><label>PIN:</label>
              <input type="text" id="key" name="key" class="form-control" maxlength="7"  onkeypress="return isNumberKey(event)"/><br/>
